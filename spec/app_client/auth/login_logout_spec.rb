...
describe '[Auth - Login - Logout]', :app_client, :auth, :login do
  ...
  it 'Logs in with a valid email, then logs out', :uuqa_5, :uuqa_1608 do
    log_in_as(email_address: Users::CC_USER, login_email: login_email, login_password: login_password)
  ...
  it 'Prevents login with incorrect password', :uuqa_9 do
    ...
    log_in_as(email_address: Users::CC_USER, password: wrong_password, login_email: login_email, login_password: login_password)
  ...
  it 'Inactive user is automatically signed off', :uuqa_778 do
    log_in_as(email_address: Users::INACTIVE_USER, login_email: login_email, login_password: login_password)
    expect(login_email.page_displayed?).to be_truthy
