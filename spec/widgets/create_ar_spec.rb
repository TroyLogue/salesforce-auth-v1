...
describe '[Assistance Request]', :widgets, :assistance_request do
  ...
  context('[Widget]') do
    it 'submit an assistance request with configured fields', :uuqa_1600 do
    ...
    it 'submit an assistance request with custom form fields', :uuqa_689 do
      school_name = 'NYU'
      school_location = 'NYC'
    ...
    it 'submit an assistance request with only default fields', :uuqa_1601 do
