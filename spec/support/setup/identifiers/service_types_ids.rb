...
# parent service type ids can be dynamically fetched using the service_type_codes identifiers
# and the service_type_id method in support/setup/base/service_types.rb
