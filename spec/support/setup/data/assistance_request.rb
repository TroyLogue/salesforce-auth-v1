...
module Setup
  module Data
    def self.submit_assistance_request_to_columbia_org
      ...
      assistance_request.create(access_token: COLUMBIA_AR_WIDGET_FORM_ID, service_type_id: BENEFITS)
      assistance_request
    end

    def self.close_columbia_assistance_request(ar_id:)
      close_ar = Setup::CloseAssistanceRequest.new
      close_ar.close(token: MachineTokens::ORG_COLUMBIA, group_id: Providers::ORG_COLUMBIA, ar_id: ar_id, resolution: RESOLVED)
      close_ar
    end
  end
end